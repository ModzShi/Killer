...
<body>
    ...
    <script>
        ...
        let ganho = <?= $valor ?>;
        let newSaldo = Number(saldoInfluencer) + Number(ganho);
        localStorage.setItem('saldoInfluencer', newSaldo);
    </script>
    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section"
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <p class="win-warn"><strong>Uau! Continue assim, você ganhou R$ <?= number_format($valor, 2, ',', '.') ?>!
                    </strong>
                </p>

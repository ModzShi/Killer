                    ...
                    success: function (data) {
                        ...
                        if (Array.isArray(data)) {
                            data.forEach(function (row) {
                                var tipoBadge = row.tipo === 'Afiliado'
                                    ? "<span class='badge badge-info' style='background:#17a2b8;padding:5px 10px;'>Afiliado</span>"
                                    : "<span class='badge badge-secondary' style='background:#6c757d;padding:5px 10px;'>Jogo</span>";
                                var newRow = "<tr data-id='" + row.id_registro + "' data-tipo='" + row.tipo + "'>" +
                                    "<td>" + tipoBadge + "</td>" +
                                    "<td>" + row.email + "</td>" +
                                    "<td>" + row.destino + "</td>" +
                                    "<td>" + row.chavepix + "</td>" +
                                    ...
                                    "<option value='Pago'>Pago (transferência concluída)</option>" +
                            ...
                            $('.btn-atualizar').on('click', function () {
                                ...
                                $.ajax({
                                    ...
                                    method: 'POST',
                                    data: { id: id, novoStatus: novoStatus, tipo: tipo },
